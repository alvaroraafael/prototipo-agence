<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
			...
			<div class="author">
				...
				<div class="quote">
					<p>"¡Hola! Soy Álvaro Güette el autor de este prototipo con fines practicos. Espero te agrade la aplicacion. Puedes seguirme en Twitter o GitHub para mas noticias."</p>
				</div>
			</div>
